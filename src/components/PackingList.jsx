  ...
  return (
    ...
    <section id="packing" style={{ backgroundColor: '#FAF7F2' }} className="py-24 px-6">
      <div className="max-w-4xl mx-auto">
        ...
        {/* Progress Bar */}
        <div className="mb-8 p-5 rounded-2xl" style={{ backgroundColor: 'white', boxShadow: '0 2px 12px rgba(0,0,0,0.06)' }}>
        ...
        {/* Category Tabs */}
        <StaggerContainer className="flex flex-wrap gap-2 mb-6">
          {categories.map((cat) => {
        ...
        {/* Checklist */}
        <StaggerContainer className="rounded-2xl overflow-hidden" style={{ boxShadow: '0 2px 12px rgba(0,0,0,0.06)' }} key={activeCategory}>
